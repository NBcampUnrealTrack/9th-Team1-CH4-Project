#include "OverSalmonCrate.h"

#include "Components/BoxComponent.h"
#include "Components/StaticMeshComponent.h"
#include "Engine/StaticMesh.h"
#include "UObject/ConstructorHelpers.h"
#include "../Item/OverSalmonItem.h"

AOverSalmonCrate::AOverSalmonCrate()
{
	IngredientClass = AOverSalmonItem::StaticClass();
	static ConstructorHelpers::FObjectFinder<UStaticMesh> Mesh(
		TEXT("/Game/Overcooked/Kitchen/StaticMeshes/SM_IngredientFridge_SalmonFish.SM_IngredientFridge_SalmonFish"));
